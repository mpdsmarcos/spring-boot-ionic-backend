...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {
		...
		Categoria cat3 = new Categoria(null, "Cama mesa e bonha");
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "mpdsmarcos@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));
		cli1.getTelefones().addAll(Arrays.asList("27363323","93838393"));
		
		Cliente cli2 = new Cliente(null, "Ana Costa", "mpdsmarcos@hotmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
